...
if(PETSC_FOUND)
  ...
  set(PETSC_INCLUDE_DIRS "${PETSC_STATIC_INCLUDE_DIRS};${PETSC_PACKAGE_INCLUDES}")
  set(PETSC_LIBRARIES "${PETSC_STATIC_LDFLAGS};${PETSC_STATIC_LIBRARIES};${PETSC_PACKAGE_LIBS}")
  if(PETSC_ZOLTAN_LIB)
